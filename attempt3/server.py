...
def threaded_client(connection):
    ...
    while(loggedin == True):
        userinputs = client_socket.recv(1024).decode('utf-8').split()
        ...
        if(user_command == "MSG"):
            ...
            client_socket.sendall(send_string)
            ...
            with open('messagelog.txt', "r+") as messagef:
                ...
                if lines == []:
                    ...
                    client_socket.sendall(read_string)
                elif lines != []:
                    for line in lines:
            ...
            with open('messagelog.txt', "r+") as messagef:
                ...
                if lines == []:
                    ...
                    client_socket.sendall(edit_string)
                elif lines != []:
                    temp = []
                    for line in lines:
                        ctimenow = ctime(time())
            ...
            with open('messagelog.txt', "r+") as messagef:
                ...
                if lines == []:
                    ...
                    client_socket.sendall(delete_string)
                elif lines != []:
                    count = 1
                    for line in lines:
                ...
                if lines != []:
                    ...
                    for line in lines:
                        ...
                        if username == stored_user:
                            ...
                            client_socket.sendall(logout_string)
                            loggedin = False
                        else:
                            logout_string = str(count)+"; "+str(stored_time) + \
                                "; "+str(stored_user)+"; "+str(stored_addr)
                            count = count + 1
            ...
            with open('userlog.txt', "r+") as userf:
                ...
                if len(lines) == 1 :
                    ...
                    client_socket.sendall(active_string)
                else:
                    for line in lines:
                        line_split = line.split(';')
                        stored_user = line_split[2]
                    ...
                    active_string = active_string.encode('utf-8')
                    client_socket.send(active_string)
